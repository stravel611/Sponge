<template>
  <div class="management-table">
    <div>
      新建分类：  
      <el-input v-model="newCategory" placeholder="请输入新分类的名称" size="medium" class="new-category-input"></el-input>
      <el-button type="primary" plain size="medium" class="new-category-button" @click="createNewCategory">提交</el-button>
    </div>
