<template>
  <div class="management-table">
    <div class="date-picker">
      <span>选择月份：</span>
      <el-date-picker v-model="timeMonth" type="month" placeholder="选择月"></el-date-picker>
    </div>
    <el-table :data="tableData" class="record-table">
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button size="mini" @click="addTag(scope.$index, scope.row)">添加标签</el-button>
          <el-button size="mini" @click="modifyRemark(scope.$index, scope.row)">修改备注</el-button>
